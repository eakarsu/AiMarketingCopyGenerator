...
// Vertical
// Vertical compliance-aware templates (medical/legal/SaaS/ecommerce)
...
export default function GapVertical() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Vertical compliance-aware templates (medical/legal/SaaS/ecommerce)</p>
