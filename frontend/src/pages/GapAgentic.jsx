...
// Agentic
// Agentic copy optimizer that batch-tests variants on ad platforms and auto-evolves winners
...
export default function GapAgentic() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Agentic copy optimizer that batch-tests variants on ad platforms and auto-evolves winners</p>
