...
// Style
// Style guide enforcement workflow

export default function GapStyle() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-style', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Style</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Style guide enforcement workflow</p>
