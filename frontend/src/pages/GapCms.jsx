...
export default function GapCms() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-cms', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Cms</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>CMS integration (WordPress, Ghost, Webflow)</p>
