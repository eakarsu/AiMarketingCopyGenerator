...
// Brand
// Brand voice consistency enforcer detecting drift across channels

export default function GapBrand() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-brand', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Brand</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Brand voice consistency enforcer detecting drift across channels</p>
